package com.simile.plan.java.clazz.sub;

//import com.simile.plan.java.clazz.ClassExample4;
 ...
 * private : 私有的，不合法
 * protected : 受保护的，不合法
 * 不写：类似protected，但是合法，且仅限于在当前包下面被继承
 *
 * @Author yitao
 * @Created 2024/10/07
 */
//编译报错
//class ClassExample43 extends ClassExample4 {
class ClassExample43 {
    //1、属性
